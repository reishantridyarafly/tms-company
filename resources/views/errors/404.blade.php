            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12 text-center">
                        ...
                        <div class="text-uppercase mt-4 display-5 fw-semibold">Halaman tidak tersedia</div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="{{ route('beranda.index') }}" class="btn btn-primary mt-4">Kembali ke Beranda</a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
